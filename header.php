              ...
              <img class="fixed" src="img/logoo.png" height="54px" width="54px" alt="" style="margin-left: -25px; margin-right: 40px;">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php"><solid style="color: black;">Home</solid></a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php#services"><solid style="color: black;">Services</solid></a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php#about"><solid style="color: black;">About</solid></a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="contact.php"><solid style="color: black;">Contact</solid></a></li>
